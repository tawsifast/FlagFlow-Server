...
import { consumePhoneNumberOTP, requestPasswordResetPhoneNumber, resetPasswordPhoneNumber, sendPhoneNumberOTP, signInPhoneNumber, verifyPhoneNumber } from "./routes.mjs";
...
const phoneNumber = (options) => {
	...
	return {
		...
		endpoints: {
			...
			consumePhoneNumberOTP: consumePhoneNumberOTP(opts),
